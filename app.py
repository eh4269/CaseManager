...
APPLICATION_NAME = "udacity-neigborhood-map"
...
# Category Items
@app.route('/CaseManagement/<path:category_name>/items/')
...
@app.route('/CaseManagement/<path:category_name>/<path:item_name>/')
...
# Add a category
@app.route('/CaseManagement/addcategory', methods=['GET', 'POST'])
@login_required
def addCategory():
...
# Edit a category
@app.route('/CaseManagement/<path:category_name>/edit', methods=['GET', 'POST'])
@login_required
...
# Delete a category
@app.route('/CaseManagement/<path:category_name>/delete', methods=['GET', 'POST'])
@login_required
...
# Add an item
@app.route('/CaseManagement/add', methods=['GET', 'POST'])
@login_required
def addItem():
...
# Edit an item
@app.route('/CaseManagement/<path:category_name>/<path:item_name>/itemedit', methods=['GET', 'POST'])
@login_required
...
# Delete an item
@app.route('/CaseManagement/<path:category_name>/<path:item_name>/itemdelete', methods=['GET', 'POST'])
...
@app.route('/CaseManagement/categories/JSON')
def categoriesJSON():
    categories = session.query(Category).all()
    return jsonify(categories=[c.serialize for c in categories])

@app.route('/CaseManagement/items/JSON')
def itemsJSON():
    items = session.query(Items).all()
    return jsonify(items=[i.serialize for i in items])

@app.route('/CaseManagement/<path:category_name>/items/JSON')
def categoryItemsJSON(category_name):
    category = session.query(Category).filter_by(name=category_name).one()
    items = session.query(Items).filter_by(category=category).all()
    return jsonify(items=[i.serialize for i in items])

@app.route('/CaseManagement/<path:category_name>/<path:item_name>/JSON')
